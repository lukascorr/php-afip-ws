        ...
        $document = [
            ...
            'FeDetReq' => [
                'FECAEDetRequest' => [
                    ...
                    'FchServDesde' => str_replace('-', '', $factura->fechaServicioDesde ?? ''),
                    'FchServHasta' => str_replace('-', '', $factura->fechaServicioHasta ?? ''),
                    'FchVtoPago' => str_replace('-', '', $factura->fechaVencimientoPago ?? ''),
